...
(let [messages (create-bundle-manager :messages ["properties"])
      errors   (create-bundle-manager :errors   ["properties"])]
...
(let [messages (create-bundle-manager "messages" ["yml" "yaml"])
      errors   (create-bundle-manager "errors"   ["yml" "yaml"])]
...
(let  [messages (create-bundle-manager :messages ["edn" "clj"])
       errors   (create-bundle-manager :errors   ["edn" "clj"])]
